...
namespace Hydrax
{
    ...
    public:
        ...
        /** Call every frame, will do a complete update including RTT and Module calculations
            @todo Add listener interface
         */
        void update(const Ogre::Real &timeSinceLastFrame);

        /** Manual update, restricted to Hydrax's RTT
         */
        void updateOnlyRTT(const Ogre::Real &timeSinceLastFrame);
