...
REM START /WAIT shadermap.exe cdiff "%cd%\GrassDead0101_15_S.jpg" -disp (*,*,8,xy) -ambo (*,*,*,*,*,0,xy) -norm (-70,400,xy,*) -spec (*,10,*,xy) -v



START /WAIT shadermap.exe cdiff "%cd%\RockLayered0027_M.jpg"  -ambo (50,*,*,70,0,0,0) -v
